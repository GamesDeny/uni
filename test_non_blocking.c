...
void test_scenario_4() {
    ...
    pthread_create(&producer_t_1, NULL, non_blocking_producer, buffer);
    pthread_create(&producer_t_2, NULL, non_blocking_producer, buffer);
...
void test_scenario_5() {
    ...
    pthread_create(&consumer_t_1, NULL, non_blocking_consumer, buffer);
    pthread_create(&consumer_t_2, NULL, non_blocking_consumer, buffer);
...
void test_scenario_7() {
    ...
    pthread_create(&producer_t_1, NULL, non_blocking_producer, buffer);
    pthread_create(&producer_t_2, NULL, non_blocking_producer, buffer);
    pthread_create(&producer_t_3, NULL, non_blocking_producer, buffer);
    pthread_create(&producer_t_4, NULL, non_blocking_producer, buffer);
...
void test_scenario_8() {
    ...
    pthread_create(&producer_t_3, NULL, non_blocking_producer, buffer);
    pthread_create(&producer_t_4, NULL, non_blocking_producer, buffer);
    pthread_create(&producer_t_5, NULL, non_blocking_producer, buffer);
